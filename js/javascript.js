...
clickedPaper.addEventListener("click", () => clicked("paper"))

clickedRock.addEventListener("click", () => clicked("rock"))

clickedScissors.addEventListener("click", () => clicked("scissors"));
...
// clickedRock.addEventListener("click", function() {
...
// clickedScissors.addEventListener("click", function() {
...
//     if (computerSelection === "rock" && clickedScissors.onclick === true) {
//         return ("Scissors loose to Rock. Computer wins!"); 
//     } else if (computerSelection === "scissors" && clickedRock.onclick === true) {
//         return ("Rock beats Scissors. You win!") 
//     } else if (computerSelection === "rock" && clickedPaper.onclick === true) {
//         return ("Paper beats Rock. You win!")
//     } else if (computerSelection === "paper" && clickedRock.onclick === true) {
//         return ("Rock looses to Paper. Computer wins!")
//     } else if (computerSelection === "paper" && clickedScissors.onclick === true) {
//         return ("Scissors beat Paper. You win!")
//     } else if (computerSelection === "scissors" && clickedPaper.onclick === true) {
//         return ("Paper looses to Scissors. Computer wins!")
//     } else if (computerSelection === "rock" && clickedRock.onclick === true) {
//         return ("Rock VS. Rock. It's a tie!")
//     } else if (computerSelection === "paper" && clickedPaper.onclick === true) {
//         return ("Paper VS. Paper. It's a tie!")
//     } else if (computerSelection === "scissors" && clickedScissors.onclick === true) {
//         return ("Scissors VS. Scissors. It's a tie!")
//     } 
// }

// let roundResult = round(computerSelection);
// console.log(roundResult);
