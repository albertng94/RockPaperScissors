...
clickedPaper.addEventListener("click", () => {
    clicked(playerSelection, "paper");
});

clickedRock.addEventListener("click", () => {
    clicked(playerSelection, "rock");
});

clickedScissors.addEventListener("click", () => {
    clicked(playerSelection, "scissors");
});
    
function clicked(playerSelection, selection) {
...
if (computerCurrentScoreUpdated > 0) {
  ...
  playerRoundScore.textContent = `${playerCurrentScoreUpdated}`;
console.log(currentScore);